      ...
      <div className="w-full lg:w-2/3 mb-12 lg:mb-0">
        <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-4/5 lg:w-unset">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="mb-10 text-secondaryText leading-loose"
          >
            We're shaking up how Bitcoin crowdfunding works. Angor is a decentralized 
            protocol, uniquely merging the security of Bitcoin with the transparency of Nostr. 
          ...
          >
            <li className="mb-4 flex items-center">
              <CheckArrowIcon />
              <span className="ml-3">Investor Empowerment</span>
            </li>
            <li className="mb-4 flex items-center">
              <CheckArrowIcon />
              <span className="ml-3">Founder Advantage</span>
            </li>
            <li className="mb-4 flex items-center">
              <CheckArrowIcon />
              <span className="ml-3">Transparent Platform</span>
            </li>
          </motion.ul>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/3 mx-auto flex flex-wrap lg:-mx-4 sm:pr-8 justify-center order-last">
        <div className="mb-8 lg:mb-0 w-full px-2 lg:pl-16 flex flex-col justify-center md:pl-8">
          <motion.div 
            ...
            className="mb-4 py-3 md:pl-20 lg:pl-12 md:pr-2 rounded hidden lg:flex"
          >
            <img
              src={bitcoin.src}
              alt="Bitcoin network security"
          ...
          <motion.div 
            ...
            className="py-3 md:pl-3 md:pr-20 lg:pr-12 rounded hidden lg:flex"
          >
            <img
              src={nostr.src}
              alt="Nostr protocol communication"
              className="rounded-xl main-border-gray mx-auto w-2/3 hover:scale-105 transition-transform duration-300"
            />
          </motion.div>
        </div>
